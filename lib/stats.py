# Player stats work on a floating scale where 99.999% of human values range between 0.33 and 3.0 and where 1.0 is
...
# equivalent to one in one hundred thousand innate talent combined with intesensive training.
...
# STRENGTH
#
# Strength is measured relative to body weight where 1.0 is ability to dead-lift 1.5 times body-weight. Smaller classes
# like dwarves who are slightly less mass than humans will have higher strength ratios (1.8 average).
...
#
# Super/human heroic strength is the ability to lift 3-8 times body weight, heroic dexterity is 3 times
# greater than a fit human). Stats of 5 to 10 are demigod and 20-50 is
...
# return an adjusted stat that is centered/oriented at 1.0 as the norm by the given percentage (above or below norm).
